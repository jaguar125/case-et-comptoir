              ...
              <>
                <div className="px-4 pt-4 pb-2 flex items-center justify-between sticky top-0 z-20 no-print" style={{ background: "var(--paper)" }}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => { setRole(null); setCurrentVendorName(""); setCart([]); setNotifications([]); setUnreadCount(0); setNotifPanelOpen(false); window.storage.delete("sessionRole").catch(() => {}); window.storage.delete("sessionVendorName").catch(() => {}); }} className="gb-focus w-9 h-9 rounded-full flex items-center justify-center" style={{ background: "var(--paper-dim)" }}><LogOut size={15} /></button>
                  </div>
                </div>

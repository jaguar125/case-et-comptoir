...
function ActivationScreen({ onActivate, onStartTrial, trialUsed, pushToast, registeredAdmin, onReconnectInstead }) {
  return (
    <div className="min-h-full flex flex-col items-center justify-center px-6 py-10 relative" style={{ background: "var(--glass)" }}>
      ...
      <button onClick={onReconnectInstead} className="gb-focus w-full max-w-xs rounded-2xl py-3.5 font-semibold text-sm active:scale-[0.98] transition-transform" style={{ background: "var(--cap)", color: "var(--glass)" }}>
